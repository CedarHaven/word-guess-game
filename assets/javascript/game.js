...
document.onkeyup=function(event) {
    ...
    // MAKE A STRING THAT IS THE UNGUESSED WORD, and then run a for loop for the word that's been picked as the word to be guessed, and make the unguessed word string an entire group of _. when the user guesses a correct letter, in the check for that, replace the _ at that index in the string with the letter the user guessed.
    // possibly like this: https://stackoverflow.com/questions/1431094/how-do-i-replace-a-character-at-a-particular-index-in-javascript, because I'm going to have to replace the character in the unguessed word string with the letter the user guessed at the same index as the string for the word they're guessing, and then append that to the...this might not work. I'm not sure how to replace a string that's already been appended to the <div> with a new string.
    // okay apparently you can use replace to put a different string in a div from what was already there? https://stackoverflow.com/questions/9448097/jquery-replace-a-string-inside-a-div
